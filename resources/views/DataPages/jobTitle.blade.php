...
@section('content')
    ...
    <div class="container-fluid px-4 pt-5">
            ...
            <div class="d-flex flex-row justify-content-between">
                ...
                <div class="d-flex flex-row gap-4 mb-4">
                    ...
                    <button class="border rounded-pill p-3 btn btn-success"><i
                        ...
                        to
                        Excel</button>
                    <a href="/add-job-title"> <button class="border rounded-pill btn btn-secondary py-3 px-5"><i
                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        @foreach ($jobTitles as $jobTitle)
                            <tr>
                                <td>{{ $jobTitle->division->kode }}</td>
                                <td>{{ $jobTitle->kode }}</td>
                                <td>{{ $jobTitle->nama }}</td>
                                <td>{{ $jobTitle->keterangan }}</td>
                                <td>{{ $jobTitle->status ? 'Active' : 'Inactive' }}</td>
                                <td class="d-flex flex-row">
                                    <i class="fa-solid fa-eye fa-lg"></i>
                                    <a href="/edit-job-title/{{ $jobTitle->id }}"><i
                                            class="fa-solid fa-pen-to-square fa-lg text-black"></i></a>
                                    <i class="fa-solid fa-print fa-lg"></i>
                                    <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal{{ $jobTitle->id }}"><i
        ...
        @foreach ($jobTitles as $jobTitle)
            <!-- Modal -->
            <div class="modal fade" id="deleteModal{{ $jobTitle->id }}" tabindex="-1"
                aria-labelledby="deleteModalLabel{{ $jobTitle->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fs-5" id="deleteModalLabel{{ $jobTitle->id }}">Delete Warning!</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="/delete-job-title/{{ $jobTitle->id }}" method="POST">
                                @csrf
                                @method('DELETE')
